import{aI as V,aJ as Ee,aK as Ae,aL as Pe,aM as Oe,aN as ve,aO as le,aP as Ie,aQ as Ue,aR as Ce,aS as je,aT as J,aU as Se,v as ce,aV as $,aW as X,aX as De,r as I,j as l,A as Le,q as Be,p as Fe,a as Me,u as $e,ar as Ve,g as He,ae as Q,L as ze,af as ee,aY as qe,aZ as te,aD as D,aj as We}from"./index-BGsO0pia.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dt(e){return e!==void 0}function ht(e){return typeof e=="object"&&!Array.isArray(e)}function pe(e){return typeof e=="string"||e instanceof String}function ne(e){return G()&&e instanceof Blob}function G(){return typeof Blob<"u"}function se(e,t,n,s){if(s<t)throw Y(`Invalid value for '${e}'. Expected ${t} or greater.`);if(s>n)throw Y(`Invalid value for '${e}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tt(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function Rt(...e){const t=Tt();if(t!==void 0){const n=new t;for(let s=0;s<e.length;s++)n.append(e[s]);return n.getBlob()}else{if(G())return new Blob(e);throw new f(p.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function wt(e,t,n){return e.webkitSlice?e.webkitSlice(t,n):e.mozSlice?e.mozSlice(t,n):e.slice?e.slice(t,n):null}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j{constructor(t,n){this._service=t,n instanceof N?this._location=n:this._location=N.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new j(t,n)}get root(){const t=new N(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return be(this._location.path)}get storage(){return this._service}get parent(){const t=It(this._location.path);if(t===null)return null;const n=new N(this._location.bucket,t);return new j(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw at(t)}}function Kt(e,t,n){e._throwIfRoot("uploadBytes");const s=Wt(e.storage,e._location,St(),new U(t,!0),n);return e.storage.makeRequestWithTokens(s,Te).then(r=>({metadata:r,ref:e}))}function Gt(e){e._throwIfRoot("deleteObject");const t=Ht(e.storage,e._location);return e.storage.makeRequestWithTokens(t,Te)}function Zt(e,t){const n=Ut(e._location.path,t),s=new N(e._location.bucket,n);return new j(e.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const we="storage";function nn(e,t,n){return e=V(e),Kt(e,t,n)}function sn(e){return e=V(e),Gt(e)}function ke(e,t){return e=V(e),en(e,t)}function rn(e=Pe(),t){e=V(e);const s=Ee(e,we).getImmediate({identifier:t}),r=Ae("storage");return r&&on(s,...r),s}function on(e,t,n,s={}){tn(e,t,n,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

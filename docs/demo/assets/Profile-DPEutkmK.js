<<<<<<<< HEAD:docs/demo/assets/Profile-SaoQ8oGE.js
import{aC as V,aD as Ee,aE as Ae,aF as Pe,aG as Oe,aH as ve,aI as le,aJ as Ie,aK as Ce,aL as Ue,aM as je,aN as J,aO as Se,v as ce,aP as $,aQ as X,aR as De,r as I,j as l,q as Le,p as Be,a as Fe,u as Me,an as $e,g as Ve,aa as Q,L as He,ab as ee,aS as ze,aT as te,ax as D,af as qe}from"./index-CtLyFsg_.js";import{A as We}from"./AssetImage-D83sM9t7.js";/**
========
import{az as V,aA as Ee,aB as Ae,aC as Pe,aD as Oe,aE as ve,aF as le,aG as Ie,aH as Ce,aI as Ue,aJ as je,aK as J,aL as Se,v as ce,aM as $,aN as X,aO as De,r as I,j as l,q as Le,p as Be,a as Fe,u as Me,al as $e,g as Ve,a8 as Q,L as He,a9 as ee,aP as ze,aQ as te,au as D,ad as qe}from"./index-QL7MZDHQ.js";import{A as We}from"./AssetImage-CQOjrW_W.js";/**
>>>>>>>> 1d0b8e3 (Let the event state where it takes registrations, or say nothing):docs/demo/assets/Profile-DPEutkmK.js
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fe(e,t,n){let s=t;return n==null&&(s=`https://${t}`),`${n}://${s}/v0${e}`}function pt(e){const t=encodeURIComponent;let n="?";for(const s in e)if(e.hasOwnProperty(s)){const r=t(s)+"="+t(e[s]);n=n+r+"&"}return n=n.slice(0,-1),n}var U;(function(e){e[e.NO_ERROR=0]="NO_ERROR",e[e.NETWORK_ERROR=1]="NETWORK_ERROR",e[e.ABORT=2]="ABORT"})(U||(U={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class C{constructor(t,n){let s=0,r="";ne(t)?(this.data_=t,s=t.size,r=t.type):t instanceof ArrayBuffer?(n?this.data_=new Uint8Array(t):(this.data_=new Uint8Array(t.byteLength),this.data_.set(new Uint8Array(t))),s=this.data_.length):t instanceof Uint8Array&&(n?this.data_=t:(this.data_=new Uint8Array(t.length),this.data_.set(t)),s=t.length),this.size_=s,this.type_=r}size(){return this.size_}type(){return this.type_}slice(t,n){if(ne(this.data_)){const s=this.data_,r=wt(s,t,n);return r===null?null:new C(r)}else{const s=new Uint8Array(this.data_.buffer,t,n-t);return new C(s,!0)}}static getBlob(...t){if(K()){const n=t.map(s=>s instanceof C?s.data_:s);return new C(Rt.apply(null,n))}else{const n=t.map(o=>pe(o)?Nt(P.RAW,o).data:o.data_);let s=0;n.forEach(o=>{s+=o.byteLength});const r=new Uint8Array(s);let i=0;return n.forEach(o=>{for(let u=0;u<o.length;u++)r[i++]=o[u]}),new C(r,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function It(e){if(e.length===0)return null;const t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t)}function Ct(e,t){const n=t.split("/").filter(s=>s.length>0).join("/");return e.length===0?n:e+"/"+n}function be(e){const t=e.lastIndexOf("/",e.length-2);return t===-1?e:e.slice(t+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+a+"--",R=C.getBlob(_,s,m);if(R===null)throw it();const k={name:d.fullPath},E=fe(i,e.host,e._protocol),b="POST",A=e.maxUploadRetryTime,O=new xe(E,b,$t(e,n),A);return O.urlParams=k,O.headers=o,O.body=R.uploadData(),O.errorHandler=ye(t),O}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

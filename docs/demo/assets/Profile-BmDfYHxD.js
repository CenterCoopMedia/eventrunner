import{aC as K,aD as $e,aE as Ve,aF as He,aG as ze,aH as qe,aI as xe,aJ as We,aK as Xe,aL as Ye,aM as Ge,aN as ue,aO as Ke,B as Re,aP as G,aQ as ne,aR as Je,r as A,aA as Ze,j as l,A as Qe,z as et,y as tt,b as nt,a as st,ab as rt,h as ot,aS as $,V as de,L as it,W as he,aT as at,a1 as V,a7 as pe}from"./index-CXyKXS27.js";import{P as lt,D as ct}from"./DefaultAvatarPicker-DohYc1ir.js";import{R as ut,C as dt}from"./Choice-CoaNXjr1.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pt(e,t,s){let n=1,r=null,o=null,a=!1,u=0;function i(){return u===2}let h=!1;function f(..._){h||(h=!0,t.apply(null,_))}function E(_){r=setTimeout(()=>{r=null,e(N,i())},_)}function w(){o&&clearTimeout(o)}function N(_,...C){if(h){w();return}if(_){w(),f.call(null,_,...C);return}if(i()||a){w(),f.call(null,_,...C);return}n<64&&(n*=2);let v;u===1?(u=2,v=0):v=(n+Math.random())*1e3,E(v)}let b=!1;function R(_){b||(b=!0,w(),!h&&(r!==null?(_||(u=2),clearTimeout(r),E(0)):_||(u=1)))}return E(0),o=setTimeout(()=>{a=!0,R(!0)},s),R}function vt(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ut{constructor(t,s,n,r,o,a,u,i,h,f,E,w=!0,N=!1){this.url_=t,this.method_=s,this.headers_=n,this.body_=r,this.successCodes_=o,this.additionalRetryCodes_=a,this.callback_=u,this.errorCallback_=i,this.timeout_=h,this.progressCallback_=f,this.connectionFactory_=E,this.retry=w,this.isUsingEmulator=N,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((b,R)=>{this.resolve_=b,this.reject_=R,this.start_()})}start_(){const t=(n,r)=>{if(r){n(!1,new X(!1,null,!0));return}const o=this.connectionFactory_();this.pendingConnection_=o;const a=u=>{const i=u.loaded,h=u.lengthComputable?u.total:-1;this.progressCallback_!==null&&this.progressCallback_(i,h)};this.progressCallback_!==null&&o.addUploadProgressListener(a),o.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&o.removeUploadProgressListener(a),this.pendingConnection_=null;const u=o.getErrorCode()===L.NO_ERROR,i=o.getStatus();if(!u||It(i,this.additionalRetryCodes_)&&this.retry){const f=o.getErrorCode()===L.ABORT;n(!1,new X(!1,null,f));return}const h=this.successCodes_.indexOf(i)!==-1;n(!0,new X(h,o))})},s=(n,r)=>{const o=this.resolve_,a=this.reject_,u=r.connection;if(r.wasSuccessCode)try{const i=this.callback_(u,u.getResponse());Ot(i)?o(i):o()}catch(i){a(i)}else if(u!==null){const i=re();i.serverResponse=u.getErrorText(),this.errorCallback_?a(this.errorCallback_(u,i)):a(i)}else if(r.canceled){const i=this.appDelete_?Ne():xt();a(i)}else{const i=yt();a(i)}};this.canceled_?s(!1,new X(!1,null,!0)):this.backoffId_=Pt(t,s,this.timeout_)}getPromise(){return this.promise_}cancel(t){this.canceled_=!0,this.appDelete_=t||!1,this.backoffId_!==null&&vt(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class X{constructor(t,s,n){this.wasSuccessCode=t,this.connection=s,this.canceled=!!n}}function jt(e,t){t!==null&&t.length>0&&(e.Authorization="Firebase "+t)}function St(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(t??"AppManager")}function Dt(e,t){t&&(e["X-Firebase-GMPID"]=t)}function Lt(e,t){t!==null&&(e["X-Firebase-AppCheck"]=t)}function Ft(e,t,s,n,r,o,a=!0,u=!1){const i=Bt(e.urlParams),h=e.url+i,f=Object.assign({},e.headers);return Dt(f,t),jt(f,s),St(f,o),Lt(f,n),new Ut(h,e.method,f,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,r,a,u)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ht(e){if(typeof atob>"u")throw kt("base-64");return atob(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kt(e){if(e.length===0)return null;const t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t)}function Jt(e,t){const s=t.split("/").filter(n=>n.length>0).join("/");return e.length===0?s:e+"/"+s}function Oe(e){const t=e.lastIndexOf("/",e.length-2);return t===-1?e:e.slice(t+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,w=`\r
--`+i+"--",N=S.getBlob(E,n,w);if(N===null)throw Nt();const b={name:h.fullPath},R=Ae(o,e.host,e._protocol),_="POST",C=e.maxUploadRetryTime,P=new Ce(R,_,an(e,s),C);return P.urlParams=b,P.headers=a,P.body=N.uploadData(),P.errorHandler=Be(t),P}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bn(e){return/^[A-Za-z]+:\/\//.test(e)}function yn(e,t){return new F(e,t)}function Ue(e,t){if(e instanceof ie){const s=e;if(s._bucket==null)throw wt();const n=new F(s,s._bucket);return t!=null?Ue(n,t):n}else return t!==void 0?_n(e,t):e}function xn(e,t){if(t&&bn(t)){if(e instanceof ie)return yn(e,t);throw se("To use ref(service, url), the first argument must be a Storage instance.")}else return Ue(e,t)}function ge(e,t){const s=t==null?void 0:t[we];return s==null?null:O.makeFromBucketSpec(s,e)}function Rn(e,t,s,n={}){e.host=`${t}:${s}`;const r=xe(t);r&&We(`https://${e.host}/b`),e._isUsingEmulator=!0,e._protocol=r?"https":"http";const{mockUserToken:o}=n;o&&(e._overrideAuthToken=typeof o=="string"?o:Xe(o,e.app.options.projectId))}class ie{constructor(t,s,n,r,o,a=!1){this.app=t,this._authProvider=s,this._appCheckProvider=n,this._url=r,this._firebaseVersion=o,this._isUsingEmulator=a,this._bucket=null,this._host=Te,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=ht,this._maxUploadRetryTime=pt,this._requests=new Set,r!=null?this._bucket=O.makeFromBucketSpec(r,this._host):this._bucket=ge(this._host,this.app.options)}get host(){return this._host}set host(t){this._host=t,this._url!=null?this._bucket=O.makeFromBucketSpec(this._url,t):this._bucket=ge(t,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(t){me("time",0,Number.POSITIVE_INFINITY,t),this._maxUploadRetryTime=t}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(t){me("time",0,Number.POSITIVE_INFINITY,t),this._maxOperationRetryTime=t}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const t=this._authProvider.getImmediate({optional:!0});if(t){const s=await t.getToken();if(s!==null)return s.accessToken}return null}async _getAppCheckToken(){if(ze(this.app)&&this.app.settings.appCheckToken)return this.app.settings.appCheckToken;const t=this._appCheckProvider.getImmediate({optional:!0});return t?(await t.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(t=>t.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(t){return new F(this,t)}_makeRequest(t,s,n,r,o=!0){if(this._deleted)return new Et(Ne());{const a=Ft(t,this._appId,n,r,s,this._firebaseVersion,o,this._isUsingEmulator);return this._requests.add(a),a.getPromise().then(()=>this._requests.delete(a),()=>this._requests.delete(a)),a}}async makeRequestWithTokens(t,s){const[n,r]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(t,s,n,r).getPromise()}}const _e="@firebase/storage",be="0.14.4";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const je="storage";function Tn(e,t,s){return e=K(e),mn(e,t,s)}function wn(e){return e=K(e),gn(e)}function Se(e,t){return e=K(e),xn(e,t)}function Nn(e=He(),t){e=K(e);const n=$e(e,je).getImmediate({identifier:t}),r=Ve("storage");return r&&kn(n,...r),n}function kn(e,t,s,n={}){Rn(e,t,s,n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

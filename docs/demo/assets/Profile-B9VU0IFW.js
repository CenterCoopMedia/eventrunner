import{aP as V,aQ as Ee,aR as Ae,aS as Pe,aT as ve,aU as Oe,aV as le,aW as Ie,aX as Ce,aY as Ue,aZ as je,a_ as J,a$ as Se,v as ce,b0 as $,b1 as Y,b2 as De,r as P,aM as Le,j as l,A as Be,q as Fe,p as Me,a as $e,u as Ve,aw as He,g as ze,ag as Q,L as qe,ah as ee,b3 as We,b4 as te,an as D,as as Ye}from"./index-C04loai0.js";import{P as Xe,D as Ge}from"./DefaultAvatarPicker-DUPD3q_O.js";import{R as Ke,C as Ze}from"./Choice-BEe_Gfjp.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class A{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let s;try{s=A.makeFromUrl(t,n)}catch{return new A(t,"")}if(s.path==="")return s;throw lt(t)}static makeFromUrl(t,n){let s=null;const r="([A-Za-z0-9.\\-_]+)";function i(y){y.path.charAt(y.path.length-1)==="/"&&(y.path_=y.path_.slice(0,-1))}const o="(/(.*))?$",u=new RegExp("^gs://"+r+o,"i"),a={bucket:1,path:3};function h(y){y.path_=decodeURIComponent(y.path)}const d="v[A-Za-z0-9_]+",k=n.replace(/[.]/g,"\\."),_="(/([^?#]*).*)?$",T=new RegExp(`^https?://${k}/${d}/b/${r}/o${_}`,"i"),x={bucket:1,path:3},g=n===ue?"(?:storage.googleapis.com|storage.cloud.google.com)":n,m="([^?#]*)",E=new RegExp(`^https?://${g}/${r}/${m}`,"i"),b=[{regex:u,indices:a,postModify:i},{regex:T,indices:x,postModify:h},{regex:E,indices:{bucket:1,path:2},postModify:h}];for(let y=0;y<b.length;y++){const S=b[y],c=S.regex.exec(t);if(c){const N=c[S.indices.bucket];let R=c[S.indices.path];R||(R=""),s=new A(N,R),S.postModify(s);break}}if(s==null)throw at(t);return s}}class pt{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ft(e,t,n){let s=1,r=null,i=null,o=!1,u=0;function a(){return u===2}let h=!1;function d(...m){h||(h=!0,t.apply(null,m))}function k(m){r=setTimeout(()=>{r=null,e(T,a())},m)}function _(){i&&clearTimeout(i)}function T(m,...E){if(h){_();return}if(m){_(),d.call(null,m,...E);return}if(a()||o){_(),d.call(null,m,...E);return}s<64&&(s*=2);let b;u===1?(u=2,b=0):b=(s+Math.random())*1e3,k(b)}let x=!1;function g(m){x||(x=!0,_(),!h&&(r!==null?(m||(u=2),clearTimeout(r),k(0)):m||(u=1)))}return k(0),i=setTimeout(()=>{o=!0,g(!0)},n),g}function mt(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fe(e,t,n){let s=t;return n==null&&(s=`https://${t}`),`${n}://${s}/v0${e}`}function _t(e){const t=encodeURIComponent;let n="?";for(const s in e)if(e.hasOwnProperty(s)){const r=t(s)+"="+t(e[s]);n=n+r+"&"}return n=n.slice(0,-1),n}var U;(function(e){e[e.NO_ERROR=0]="NO_ERROR",e[e.NETWORK_ERROR=1]="NETWORK_ERROR",e[e.ABORT=2]="ABORT"})(U||(U={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function St(e){let t;try{t=JSON.parse(e)}catch{return null}return bt(t)?t:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dt(e){if(e.length===0)return null;const t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t)}function Lt(e,t){const n=t.split("/").filter(s=>s.length>0).join("/");return e.length===0?n:e+"/"+n}function _e(e){const t=e.lastIndexOf("/",e.length-2);return t===-1?e:e.slice(t+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,_=`\r
--`+a+"--",T=C.getBlob(k,s,_);if(T===null)throw ut();const x={name:h.fullPath},g=fe(i,e.host,e._protocol),m="POST",E=e.maxUploadRetryTime,O=new xe(g,m,Wt(e,n),E);return O.urlParams=x,O.headers=o,O.body=T.uploadData(),O.errorHandler=ye(t),O}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j{constructor(t,n){this._service=t,n instanceof A?this._location=n:this._location=A.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new j(t,n)}get root(){const t=new A(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return _e(this._location.path)}get storage(){return this._service}get parent(){const t=Dt(this._location.path);if(t===null)return null;const n=new A(this._location.bucket,t);return new j(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw dt(t)}}function en(e,t,n){e._throwIfRoot("uploadBytes");const s=Zt(e.storage,e._location,Mt(),new C(t,!0),n);return e.storage.makeRequestWithTokens(s,Te).then(r=>({metadata:r,ref:e}))}function tn(e){e._throwIfRoot("deleteObject");const t=Xt(e.storage,e._location);return e.storage.makeRequestWithTokens(t,Te)}function nn(e,t){const n=Lt(e._location.path,t),s=new A(e._location.bucket,n);return new j(e.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

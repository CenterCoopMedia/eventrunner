import{aY as K,aZ as $e,a_ as Ve,a$ as He,b0 as ze,b1 as qe,b2 as xe,b3 as We,b4 as Xe,b5 as Ye,b6 as Ge,b7 as ue,b8 as Ke,w as Re,b9 as G,ba as ne,bb as Ze,r as A,aW as Je,j as l,A as Qe,v as et,q as tt,a as nt,u as st,az as rt,h as ot,bc as $,ai as de,L as it,aj as he,bd as at,ap as V,av as pe}from"./index-yJXQngQX.js";import{P as lt,D as ct}from"./DefaultAvatarPicker-DLzc_4kW.js";import{R as ut,C as dt}from"./Choice-Clp1B7FX.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vt(e,t,s){let n=1,r=null,o=null,a=!1,u=0;function i(){return u===2}let h=!1;function f(...b){h||(h=!0,t.apply(null,b))}function E(b){r=setTimeout(()=>{r=null,e(N,i())},b)}function w(){o&&clearTimeout(o)}function N(b,...C){if(h){w();return}if(b){w(),f.call(null,b,...C);return}if(i()||a){w(),f.call(null,b,...C);return}n<64&&(n*=2);let P;u===1?(u=2,P=0):P=(n+Math.random())*1e3,E(P)}let _=!1;function R(b){_||(_=!0,w(),!h&&(r!==null?(b||(u=2),clearTimeout(r),E(0)):b||(u=1)))}return E(0),o=setTimeout(()=>{a=!0,R(!0)},s),R}function Pt(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class ee{constructor(t,s){this.data=t,this.contentType=s||null}}function zt(e,t){switch(e){case I.RAW:return new ee(Ee(t));case I.BASE64:case I.BASE64URL:return new ee(ve(e,t));case I.DATA_URL:return new ee(Wt(t),Xt(t))}throw re()}function Ee(e){const t=[];for(let s=0;s<e.length;s++){let n=e.charCodeAt(s);if(n<=127)t.push(n);else if(n<=2047)t.push(192|n>>6,128|n&63);else if((n&64512)===55296)if(!(s<e.length-1&&(e.charCodeAt(s+1)&64512)===56320))t.push(239,191,189);else{const o=n,a=e.charCodeAt(++s);n=65536|(o&1023)<<10|a&1023,t.push(240|n>>18,128|n>>12&63,128|n>>6&63,128|n&63)}else(n&64512)===56320?t.push(239,191,189):t.push(224|n>>12,128|n>>6&63,128|n&63)}return new Uint8Array(t)}function qt(e){let t;try{t=decodeURIComponent(e)}catch{throw q(I.DATA_URL,"Malformed data URL.")}return Ee(t)}function ve(e,t){switch(e){case I.BASE64:{const r=t.indexOf("-")!==-1,o=t.indexOf("_")!==-1;if(r||o)throw q(e,"Invalid character '"+(r?"-":"_")+"' found: is it base64url encoded?");break}case I.BASE64URL:{const r=t.indexOf("+")!==-1,o=t.indexOf("/")!==-1;if(r||o)throw q(e,"Invalid character '"+(r?"+":"/")+"' found: is it base64 encoded?");t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let s;try{s=Ht(t)}catch(r){throw r.message.includes("polyfill")?r:q(e,"Invalid character found")}const n=new Uint8Array(s.length);for(let r=0;r<s.length;r++)n[r]=s.charCodeAt(r);return n}class Pe{constructor(t){this.base64=!1,this.contentType=null;const s=t.match(/^data:([^,]+)?,/);if(s===null)throw q(I.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=s[1]||null;n!=null&&(this.base64=Yt(n,";base64"),this.contentType=this.base64?n.substring(0,n.length-7):n),this.rest=t.substring(t.indexOf(",")+1)}}function Wt(e){const t=new Pe(e);return t.base64?ve(I.BASE64,t.rest):qt(t.rest)}function Xt(e){return new Pe(e).contentType}function Yt(e,t){return e.length>=t.length?e.substring(e.length-t.length)===t:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,w=`\r
--`+i+"--",N=S.getBlob(E,n,w);if(N===null)throw Nt();const _={name:h.fullPath},R=Ae(o,e.host,e._protocol),b="POST",C=e.maxUploadRetryTime,v=new Ce(R,b,an(e,s),C);return v.urlParams=_,v.headers=a,v.body=N.uploadData(),v.errorHandler=Be(t),v}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

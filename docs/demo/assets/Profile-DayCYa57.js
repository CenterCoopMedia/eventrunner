import{aY as K,aZ as $e,a_ as Ve,a$ as He,b0 as ze,b1 as qe,b2 as xe,b3 as We,b4 as Xe,b5 as Ye,b6 as Ge,b7 as ue,b8 as Ke,w as Re,b9 as G,ba as ne,bb as Ze,r as A,aW as Je,j as l,A as Qe,v as et,q as tt,a as nt,u as st,az as rt,h as ot,bc as $,ai as de,L as it,aj as he,bd as at,ap as V,av as pe}from"./index-BLBV6A2L.js";import{P as lt,D as ct}from"./DefaultAvatarPicker-Doz02nDV.js";import{R as ut,C as dt}from"./Choice-ei8iGmbH.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vt(e,t,s){let n=1,r=null,o=null,a=!1,u=0;function i(){return u===2}let h=!1;function f(...b){h||(h=!0,t.apply(null,b))}function E(b){r=setTimeout(()=>{r=null,e(k,i())},b)}function w(){o&&clearTimeout(o)}function k(b,...C){if(h){w();return}if(b){w(),f.call(null,b,...C);return}if(i()||a){w(),f.call(null,b,...C);return}n<64&&(n*=2);let P;u===1?(u=2,P=0):P=(n+Math.random())*1e3,E(P)}let _=!1;function R(b){_||(_=!0,w(),!h&&(r!==null?(b||(u=2),clearTimeout(r),E(0)):b||(u=1)))}return E(0),o=setTimeout(()=>{a=!0,R(!0)},s),R}function Pt(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,w=`\r
--`+i+"--",k=S.getBlob(E,n,w);if(k===null)throw kt();const _={name:h.fullPath},R=Ae(o,e.host,e._protocol),b="POST",C=e.maxUploadRetryTime,v=new Ce(R,b,an(e,s),C);return v.urlParams=_,v.headers=a,v.body=k.uploadData(),v.errorHandler=Be(t),v}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

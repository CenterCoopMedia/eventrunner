...
- **Navigation is the rail:** A grouped standing list of words on the dark rail ground down the leading edge — content, people, operations, system — with group heads as small uppercase folios. No icon rail, no collapse to glyphs, no counts in bubbles. The current item carries four signals, never color alone: The leading-edge marker, the bold weight, the filled action-blue ground, and `aria-current="page"`. The client's mark sits at the head of the rail on a small white tile.

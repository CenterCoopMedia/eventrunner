...
The code is [Apache-2.0](https://github.com/CenterCoopMedia/run-of-show/blob/main/LICENSE). Anyone can read it. CCM's service is:
...
What v1 does not include is in the [triage record](https://github.com/CenterCoopMedia/run-of-show/blob/main/docs/plans/2026-08-16-event-platform-v1-triage.md): video generation, bulk announcement mail, invoicing, social feeds, speaker chat.
...
Open a [General](https://github.com/CenterCoopMedia/run-of-show/discussions/new?category=general) thread or email info@collaborativejournalism.org. Do not send an attendee list to GitHub.

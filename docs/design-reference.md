...
- **Updates feed** — a timeline with standing heads that can open with one **Featured** post under its own folio (a larger title, a dateline and a standfirst on the same spine, never a card), and a post's category is a plain tag beside its title, before **Pinned**.

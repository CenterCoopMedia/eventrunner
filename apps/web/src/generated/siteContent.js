...
export const siteContent = {
  ...
  privacy_intro__summary: {
    ...
    field: 'summary',
    blockType: 'richtext',
    value: '<p>Harborlight Cooperative operates this event site and is responsible for the personal information described here. This template describes how the site works today; it has not been reviewed by counsel. [Client legal review required]</p>',
    visible: true,
    order: 0,
    seeded: true,
  },
  ...
  terms_intro__summary: {
    ...
    field: 'summary',
    blockType: 'richtext',
    value: '<p>These terms cover the use of this event site, operated by Harborlight Cooperative. This template describes how the site works today; it has not been reviewed by counsel. [Client legal review required]</p>',
    visible: true,
    order: 0,
    seeded: true,
  },
